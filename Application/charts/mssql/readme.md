...
The original version can be found at https://github.com/microsoft/mssql-docker/tree/master/linux/sample-helm-chart and this version was modified to allow including a timezone parameter to customize the installation.
